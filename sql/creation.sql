...
DROP TABLE IF EXISTS `Parent` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Nounou` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Langue` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Parler` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Disponibilite` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Avoir` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Evaluer` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Enfant` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `Experience` CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS `DemandeDeGarde` CASCADE CONSTRAINTS;
